 ...
 * AESSomeTest
 */
public final class AESSomeTest extends BaseTest {
	...
	public void testDecrypt() {
		try {
			String path = ProjectUtil.getAbsolutePath("/doc/5UyqBRZ8066000.ts", true);
			byte[] data = FileUtil.getByteArray(path);
			
			String password = "beb2daa98fec8bf8";
